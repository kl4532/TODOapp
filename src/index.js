...
class MyToDoList extends React.Component {
  constructor() {
    ...
    this.handleDelSelected = this.handleDelSelected.bind(this);
  ...
  render() {
    ...
    return (
      <div className="frame">
        ...
        <button className ="btn inpTask" onClick={this.handleAdd}>Add task</button>
        <button className ="btn inpTask" onClick={this.handleDelSelected}>Remove selected</button>
        <div className="items">
          <ul>
            {items}
          </ul>
